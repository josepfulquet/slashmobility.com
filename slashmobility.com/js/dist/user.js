...
'use strict';
  ...
  */
	...
	let _self				= null; //for events
    	...
    	//util.inherits(ModuleName, _events); //if you want events

    function User(options){

        if (typeof options === "undefined") throw new TypeError("no data");
        if (typeof options.env === 'undefined') throw new TypeError('environment error');
	...
	function signin(username, password){
		if (typeof username === "undefined") throw new TypeError("no username");
		if (typeof password === "undefined") throw new TypeError("no password");

		let dataToSend = {};
		dataToSend.username = username;
		dataToSend.password = password;
		dataToSend.useragent = _options.userAgent;
		dataToSend.method = "signin";
